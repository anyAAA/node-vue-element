  ...
  <div class="userlist" v-if="user.identity=='manager'">
    <div>
      <el-form :inline="true" ref="add_data" :model="search_user">
        <el-form-item label="按照用户筛选:">
          <el-row>
            <el-col :span="12">
              <el-input v-model="search_user.name" type="text" placeholder="用户名" size="small"></el-input>
            </el-col>
            <el-col :span="12">
              <el-select v-model="search_user.identity" placeholder="用户身份" size="small">
    ...
    <div class="table_container">
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="name" label="用户" align="center" :span="8"></el-table-column>
        <el-table-column prop="email" label="邮箱" align="center" :span="8"></el-table-column>
        <el-table-column prop="identity" label="身份" align="center" :span="8"></el-table-column>
      </el-table>
      <el-row>
        <el-col :span="24">
